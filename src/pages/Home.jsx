    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      ...
      <section className="relative min-h-[calc(100vh-72px)] flex flex-col justify-center py-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="/images/hero-bg.jpg" alt="Background" className="w-full h-full object-cover opacity-15" />
        </div>
        <div className="max-w-[1200px] mx-auto px-[20px] md:px-[40px] lg:px-[60px] relative z-10 w-full text-center">
          ...
          <p className="font-inter text-[#707070] text-[18px] max-w-[580px] mx-auto mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[800px] mx-auto divide-y md:divide-y-0 md:divide-x divide-white/10">
            {[["50+", "Projects Delivered"], ["100%", "Client Satisfaction"], ["10+", "Industries Served"]].map(([num, label]) => (
              <div key={label} className="pt-4 md:pt-0 flex flex-col items-center">
                ...
                <span className="font-inter text-[14px] text-[#707070] uppercase tracking-wider">{label}</span>
              </div>
            ))}
          </div>

          <div className="mt-24 relative max-w-[700px] mx-auto">
            <img src="/images/hero-visual.jpg" alt="Dashboard" className="w-full rounded-[20px] shadow-[0_0_80px_rgba(0,255,148,0.12)]" />
            <GlassCard className="absolute -bottom-10 -left-10 w-[240px] hidden md:block !p-5">
              <div className="flex items-center gap-3 mb-4"><BarChart3 className="text-mint"/><div><p className="text-sm font-semibold text-white">SEO Growth</p><p className="text-xs text-[#707070]">Past 30 days</p></div></div>
            ...
            <GlassCard className="absolute -bottom-10 -right-10 w-[260px] hidden md:block !p-5">
              ...
              <div className="text-xs text-[#707070] space-y-1"><p>Response: 0.8s</p><p>Score: 97/100</p><p>72hr delivery: Success</p></div>
            </GlassCard>
          </div>
        </div>
      </section>
      ...
      <section className="w-full border-y border-white/5 bg-white/5 py-5 overflow-hidden flex flex-col items-center justify-center">
        <p className="font-inter text-[13px] text-[#707070] mb-3">Trusted by businesses across</p>
      ...
      <Section id="services">
        <div className="text-center mb-16">
          ...
          <p className="text-[#707070] mt-4 text-lg">Comprehensive digital marketing solutions designed for US small businesses.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { t: "Website Design", d: "Professional 5-page websites from $497. Mobile-first, fast-loading, built to convert visitors into customers.", i: "service-web.jpg" },
            { t: "Local SEO", d: "Rank on Google Maps and search results. Get found by customers searching for your services right now.", i: "service-seo.jpg" },
            { t: "Google Ads", d: "Targeted campaigns that bring ready-to-buy customers directly to your business.", i: "service-google-ads.jpg" },
            { t: "Social Media Marketing", d: "Build your audience and grow brand awareness across all major platforms.", i: "service-social.jpg" },
            { t: "Meta Ads", d: "Facebook and Instagram advertising that reaches your ideal US customers precisely.", i: "service-meta.jpg" },
            { t: "App Development", d: "Custom iOS and Android apps that keep your customers engaged and coming back.", i: "service-app.jpg" }
          ].map((s, i) => (
            <a href="/services" key={i} className="group flex flex-col glass-card !p-0 overflow-hidden hover:-translate-y-1 transition-all">
              <img src={`/images/${s.i}`} alt={s.t} className="w-full h-[200px] object-cover rounded-t-[12px]" loading="lazy" />
              <div className="p-7 flex-grow flex flex-col">
                <CheckCircle2 className="text-mint mb-3 w-6 h-6" />
                <h3 className="font-syne font-bold text-xl text-[#F5F5F5] mb-2">{s.t}</h3>
                <p className="text-[#707070] text-[15px] flex-grow mb-4">{s.d}</p>
      ...
      <Section>
        <div className="text-center mb-16">
          ...
          <p className="text-[#707070] mt-4 text-lg">Real results from real businesses across the United States.</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
          {[
            { i: "portfolio-restaurant.jpg", tag: "Website Design", b: "Cultivating Elegance Restaurant", l: "Dallas, TX", r: "+40% online reservations" },
            { i: "portfolio-contractor.jpg", tag: "Website + SEO + Ads", b: "Elite Builders Group", l: "Austin, TX", r: "Page 1 Google in 45 days" },
            { i: "portfolio-salon.jpg", tag: "Complete Digital Presence", b: "Opulence Beauty", l: "Miami, FL", r: "+40% bookings" }
          ].map((p, i) => (
            <GlassCard key={i} className="!p-0 overflow-hidden">
              <img src={`/images/${p.i}`} alt={p.b} className="w-full h-[220px] object-cover" loading="lazy" />
              <div className="p-6">
      ...
      <Section bg="bg-surface">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
          ...
          {[
            { n: "01", t: "Discovery", d: "We learn your business, goals, and target customers inside out.", img: "process-discovery.jpg" },
            { n: "02", t: "Strategy", d: "We build a custom digital marketing plan designed for your specific market.", img: "process-strategy.jpg" },
            { n: "03", t: "Build & Launch", d: "Website live, campaigns running, and tracking set up in 72 hours.", img: "process-building.jpg" },
            { n: "04", t: "Grow", d: "We monitor, optimize, and scale until you dominate your market.", img: "process-growth.jpg" }
          ].map((s, i) => (
            <div key={i} className="relative z-10 flex flex-col items-center text-center">
              <img src={`/images/${s.img}`} alt={s.t} className="w-[160px] h-[160px] object-cover rounded-full border-4 border-primary mb-6 shadow-xl" loading="lazy" />
              ...
              <p className="text-[#707070] text-sm">{s.d}</p>
            </div>
          ))}
        </div>
      </Section>
      ...
      <section className="w-full bg-mint/5 border-y border-mint/15 py-24">
        <div className="max-w-[1200px] mx-auto px-5 text-center">
          ...
          <p className="text-[#707070] text-lg mb-8 max-w-[600px] mx-auto">Get your free website audit — no obligation, no credit card, no strings attached.</p>
