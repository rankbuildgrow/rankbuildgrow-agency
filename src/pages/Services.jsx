...
export default function Services() {
  const sections = [
    {
      id: "web", img: "service-web.webp", align: "left", title: "Professional Website Design & Development",
    ...
    {
      id: "seo", img: "service-seo.webp", align: "right", title: "Local SEO & Google Ranking",
    ...
    {
      id: "ads", img: "service-google-ads.webp", align: "left", title: "Google Ads Management",
    ...
    {
      id: "meta", img: "service-meta.webp", align: "right", title: "Meta Ads — Facebook & Instagram",
    ...
    {
      id: "social", img: "service-social.webp", align: "left", title: "Social Media Marketing",
    ...
    {
      id: "app", img: "service-app.webp", align: "right", title: "Mobile App Development",
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <section className="pt-32 pb-20 text-center max-w-[900px] mx-auto px-5">
        ...
        <p className="text-[#888888] text-lg">Everything you need to dominate your market online — from websites to ads to apps.</p>
      </section>
        ...
        <Section key={s.id} bg={idx % 2 === 0 ? "bg-surface" : "bg-primary"}>
          <div className={`flex flex-col ${s.align === 'right' ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-12 items-center`}>
            <div className="w-full lg:w-1/2">
              <img src={`/images/${s.img}`} alt={s.title} className="w-full h-[400px] object-cover rounded-2xl shadow-2xl" loading="lazy" width="600" height="400" />
            </div>
            <div className="w-full lg:w-1/2">
              <GradientHeading className="text-3xl mb-4">{s.title}</GradientHeading>
              <p className="text-[#888888] text-lg mb-6">{s.desc}</p>
          ...
          {s.pricing && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
              <GlassCard className="flex flex-col">
                ...
                <ul className="space-y-3 text-[#888888] mb-8 flex-grow"><li>5 pages</li><li>Mobile responsive</li><li>Contact form</li><li>Basic SEO</li><li>72 hours delivery</li></ul>
              ...
              <GlassCard className="flex flex-col">
                ...
                <ul className="space-y-3 text-[#888888] mb-8 flex-grow"><li>12 pages</li><li>Full SEO optimization</li><li>Google Ads integration</li><li>Booking system</li><li>Priority support</li><li>7 days delivery</li></ul>
                <Button variant="secondary" href="/contact" className="w-full">Get Started</Button>
              </GlassCard>
            </div>
          )}
