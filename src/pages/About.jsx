  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <section className="relative pt-40 pb-32 flex justify-center items-center">
        <div className="absolute inset-0 z-0"><img src="/images/about-workspace.jpg" className="w-full h-full object-cover" alt="Workspace"/><div className="absolute inset-0 bg-[#0A0A0A]/85"></div></div>
        <div className="relative z-10 text-center max-w-[800px] px-5">
          ...
          <p className="text-[#707070] text-lg">We're obsessed with one thing — getting US small businesses the online presence they deserve.</p>
        </div>
      </section>

      <Section>
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <img src="/images/strategy-visual.jpg" alt="Strategy" className="w-full lg:w-1/2 rounded-[16px] object-cover h-[400px]" loading="lazy" />
          <div className="lg:w-1/2">
            <GradientHeading className="mb-6">Our Story</GradientHeading>
            <p className="text-[#707070] mb-6">RankBuildGrow is an AI-Powered Digital Marketing Agency that was founded on a simple premise: small businesses deserve enterprise-level digital marketing without the ridiculous price tag. We saw too many US businesses struggling to get found online while competitors with deeper pockets took all the customers.</p>
            <div className="border-l-4 border-mint pl-6 py-2 mb-6 bg-mint/5"><h4 className="text-white font-bold mb-1">Our Mission</h4><p className="text-[#707070]">To empower small businesses with enterprise-level digital marketing.</p></div>
            <div className="border-l-4 border-mint pl-6 py-2 bg-mint/5"><h4 className="text-white font-bold mb-1">Our Vision</h4><p className="text-[#707070]">A world where business size never limits digital presence.</p></div>
          </div>
        </div>
      </Section>
      ...
      <Section>
        <div className="text-center mb-16">
          ...
          <p className="text-[#707070] mt-4">When you work with RankBuildGrow, you work directly with senior expertise — not handed off to a junior. Every project gets our full attention and commitment.</p>
        </div>
        <GlassCard className="max-w-[400px] mx-auto text-center">
          <img src="/images/founder.jpg" alt="Founder" className="w-[80px] h-[80px] rounded-full mx-auto mb-4 object-cover" />
          ...
          <p className="text-[#707070] text-sm">Specialist in digital marketing for US small businesses. Combining web design, SEO, and paid advertising to deliver complete digital growth solutions.</p>
        </GlassCard>
      </Section>
      ...
      <Section bg="bg-surface">
        <div className="text-center mb-12">
          ...
          <p className="text-[#707070] mt-2">Industry-leading tools to deliver results you can measure.</p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-[800px] mx-auto">
          {["Google Analytics", "Meta Business", "Canva", "SEMrush", "Ahrefs", "Mailchimp", "Shopify", "WordPress"].map(t => (
            <div key={t} className="bg-primary border border-[#2A2A2A] rounded-lg py-6 text-center text-[#707070] font-syne font-bold hover:text-mint hover:border-mint transition-colors cursor-pointer">{t}</div>
          ))}
        </div>
      </Section>
      ...
      <Section>
        <div className="relative rounded-[20px] overflow-hidden">
          <img src="/images/global-reach.jpg" alt="Global" className="w-full h-[400px] object-cover" loading="lazy" />
